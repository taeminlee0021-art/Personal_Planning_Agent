...
import type { AgentResponse, PendingAction } from "@/lib/types"
import { ReviewCard } from "@/components/planner/shared"
import { Button } from "@/components/ui/button"
import { Empty, EmptyDescription, EmptyHeader, EmptyMedia, EmptyTitle } from "@/components/ui/empty"
import { Textarea } from "@/components/ui/textarea"

export function AgentView({ loading, message, setMessage, sending, latestResponse, actions, deciding, sendMessage, decide }: { loading: boolean; message: string; setMessage: (value: string) => void; sending: boolean; latestResponse: AgentResponse | null; actions: PendingAction[]; deciding: boolean; sendMessage: (event: FormEvent) => Promise<void>; decide: (id: number, decision: "approve" | "reject") => Promise<void> }) {
